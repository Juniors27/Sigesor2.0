...
export default function BandejaObservadosPageScreen() {
  ...
  const exportToExcel = () => {
    ...
    XLSX.writeFile(workbook, "FuasObservados.xlsx")
  }
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        <section className="rounded-[28px] border border-white/10 bg-slate-900/80 p-6 shadow-xl shadow-slate-950/20">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-semibold text-white">Bandeja Observados</h1>
              <p className="mt-1 text-sm text-slate-400">Consulta registros observados con filtros por periodo, fecha o número de FUA.</p>
            </div>
          </div>
